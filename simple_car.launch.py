...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        #     output='screen',
        #     prefix='xterm -e',  # Optional: Open in a new terminal window
        #     remappings=[
        #         ('/cmd_vel', '/cmd_vel')  # Ensure the topic matches the bridge setup
        #     ]
        # ),
        ...
        Node(
    package='my_pkg',  # Replace 'my_pkg' with your package name
    executable='send_velocity',  # Replace with the name of the Python executable
    name='send_velocity',
    output='screen',
    remappings=[
        ('/cmd_vel', '/cmd_vel')  
    ...
    parameters=[
        {
            # Optionally add parameters here if your node requires any
        }
    ],
)
